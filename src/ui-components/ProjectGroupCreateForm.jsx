...
export default function ProjectGroupCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new ProjectGroup(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "ProjectGroupCreateForm")}
      {...rest}
    >
      <TextField
        label="Title"
